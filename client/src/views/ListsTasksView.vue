                        ...
                        <Modal id="updateModal">
                            ...
                            <template #content>
                                <form>
                                    ...
                                    <h3 class="mb-5 text-lg font-medium text-gray-900 dark:text-white">Assigner à:
                                    </h3>
                                        ...
                                        <li>
                                            ...
                                            <label for="angular-option"
                                                ...
                                                <div class="block">
                                                    ...
                                                    <div class="w-full text-sm">A TypeScript-based web application
                                                        framework.</div>
                                                </div>
                                            </label>
                                        </li>
...
const list1 = ref([
    { name: "Les utilisateurs devront pouvoir créer, modifier et supprimer des tâches.", id: 1 },
    { name: "Les tâches devront être affectées à d'autres utilisateurs.", id: 2 },
    { name: "Les tâches devront être triées par priorité et date d'échéance.", id: 3 },
    { name: "Les tâches devront pouvoir être marquées comme terminées ou en cours.", id: 4 }
])


const list2 = ref([
    { name: "Les utilisateurs devront pouvoir créer, modifier et supprimer des listes de tâches.", id: 5 },
    { name: "Les listes de tâches devront pouvoir contenir plusieurs tâches.", id: 6 },
    { name: "Les listes de tâches devront être triées par ordre alphabétique.", id: 7 }
]);
...
// Array for false users to assign a task with a ref
const users = ref([
    { name: "John", id: 1 },
    { name: "Joao", id: 2 },
    { name: "Jean", id: 3 },
